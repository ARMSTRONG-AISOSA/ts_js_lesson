...
const houseItems = ['chair', 'tables', 'cabinent', 'fridge', 'television', 'shelf'];
const removedHouseItems = houseItems.splice(2, 3);
...
const removedColors = colors.splice(1, 3, 'yellow', 'pink', 'brown', 'orange');
console.log("\nRemoved colors:");
...
const removedAnimal = animals.splice(1, 0, 'sheep', 'goat');
console.log("\nRemoved Animals:");
...
const groceryList = ['milk', 'eggs', 'bread', 'cheese', 'ham', 'juice'];
const removedGroceryListItems = groceryList.splice(3);
