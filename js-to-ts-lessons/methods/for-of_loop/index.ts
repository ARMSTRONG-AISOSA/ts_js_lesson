...
const colors: string[] = ['red', 'green', 'blue', 'brown', 'pink'];
...
const sentence: string = "Jeff the land shark";
...
const companyName: string[] = ["Netflix", "Google", "Microsoft", "Apple", "Amazon", "Nvidia"];
