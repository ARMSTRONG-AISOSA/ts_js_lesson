...
// Basic usage
const string1 = 'Hello world, welcome to the world.';
const firstIndex1 = string1.indexOf('world');
console.log("\nThe first index of 'world':");
console.log(firstIndex1);

// Using fromIndex: find same item next
const secondIndex1 = string1.indexOf('world', firstIndex1 + 1);
console.log("\nThe second index of 'world':");
console.log(secondIndex1);

// Not found: returns -1
const notFound1 = string1.indexOf('guess');
console.log("\nThe index of 'guess':");
...
// Basic usage:
const fruitsArray = ['apple', 'banana', 'cherry', 'apple'];
const firstIndexFruit = fruitsArray.indexOf('cherry');
console.log("\nThe index of 'cherry' in the array:");
console.log(firstIndexFruit);


// Finding duplicates:
const firstApple = fruitsArray.indexOf('apple');
const secondApple = fruitsArray.indexOf('apple', firstApple + 1);
...
const notFound = fruitsArray.indexOf('grape');
