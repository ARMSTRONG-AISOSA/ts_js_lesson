...
class Cat extends Animal {
    ...
    animal: string = "cat"; // class property @notes -> index 1
...
class Fish extends Animal {
    ...
    animal: string = "fish"; // class property

    constructor(name: string, age: number, swimSpeed: number | string) {
        super(name, age, "fish");
...
class Bird extends Animal {
    ...
    animal: string = "bird"; // class property
